...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Set up jump system events
        jumpSystem.OnJump += () => {
            anim.SetTrigger("Jump");
            audioSystem.PlayJumpSound(false);
            visualEffects.PlayJumpParticles(false);
        };
        
        jumpSystem.OnDoubleJump += () => {
            anim.SetTrigger("DoubleJump");
            audioSystem.PlayJumpSound(true);
            visualEffects.PlayJumpParticles(true);
        };
    ...
    private void HandleSpeedMomentum()
    {
        ...
        {
            visualEffects.StartSpeedParticles();
        }
        else
        {
    ...
    // Public API - Module Access for External Scripts
    ...
    // Convenience methods for common external modifications
